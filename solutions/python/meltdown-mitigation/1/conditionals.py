...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    if temperature * neutrons_produced_per_second < threshold * 90 /100:
        return "LOW"
    if threshold - (threshold * 10/100) <= temperature * neutrons_produced_per_second <= threshold:
        return "NORMAL"
    if threshold <= temperature * neutrons_produced_per_second <= threshold + (threshold * 10/100):
        return "NORMAL"
    return "DANGER"
